...
<div class="col aa">
        	<section class="section mypage">
				...
				<div class="section_body mw1200">
					...
					<form role="form" method=POST action=noticeInsert?pageNum=1 onsubmit="return confirm('공지를 등록 하시겠습니까?');">
                    <br>
                    <div class="input-group-prepend">
                        ...
                        <span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </span>
                        <input type="text" class="form-control" id="noticeSj" name="noticeSj" placeholder="공지제목을 입력해 주세요" style="width:625px;" required>
                    </div>
                    ...
                    <div class="input-group-prepend">
                       ...
                       <textarea name="content" class="form-control" rows="13"cols="100"style="width: 625px" placeholder="내용을 입력해 주세요"></textarea>
                    </div>
